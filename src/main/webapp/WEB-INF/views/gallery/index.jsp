...
<link href="https://fonts.googleapis.com/css?family=Do+Hyeon|Noto+Sans+KR&display=swap&subset=korean" rel="stylesheet">
...
<body>
	<div id="container">
		...
		<div id="content">
			<div id="gallery">
				<div id ="gallery_wrap">
					<img id="galleryimg" src="${pageContext.request.contextPath }/assets/images/attach.png">
					<h1>GALLERY</h1>
					...
					<ul>
						<li>
							<a href="${pageContext.request.contextPath }/assets/gallery-examples/im1.jpg"
								...
								class="image" style="background-image:url('${pageContext.request.contextPath }/assets/gallery-examples/im1.jpg')">&nbsp;</a>
